  ...
  return (
    <div className="about" style={{overflowY:"auto"}}>
      ...
      <p id="description">
        ...
        determined by the crime's recency. Red markers are the most recent crimes and blue
        markers are the least recent crimes. By using the crime threshold slider,
        you can see how old each crime is, and also filter out crimes that happened in the past.
      </p>
      ...
      <p id="description">
        ...
        . By clicking on the addresses on the Place column, you can see the crime's location on
        a small map that appears on your screen.
        If you move your cursor next to the name of each column, an arrow and three dots
        will appear. By clicking on the arrows, you can sort each section by ascending or
        descending order. If you click on the three dots, it will provide you with several options,
        including a filter. You can use this to filter out crimes with specific information. For
        instance, selecting Crime Description, contains, and theft will filter all crimes related to
        theft. 
      </p>
      ...
      <p id="description">
        ...
        <code>react-map-gl</code> to display the map. The data for the map
        is scraped from the{" "}
        <a href="https://police.illinois.edu/crime-reporting/daily-crime-log/">
          University Police Daily Crime Log
        </a>
